...
def main():
    ...
    print(f"Generating 8 rollouts per question for {len(prompts)} hard theorems...")
    ...
    for i, output in enumerate(outputs):
        ...
        result_dict["rollouts"] = rollouts
        results.append(result_dict)

    os.makedirs("dt_phase2", exist_ok=True)
    output_file = f"dt_phase2/p2_rollouts_chunk_{args.chunk_id}.json"
