#!/bin/bash
#SBATCH --job-name=eval_limo_dt
#SBATCH --output=logs/eval_limo_dt/eval_limo_%A_%a.out
#SBATCH --error=logs/eval_limo_dt/eval_limo_%A_%a.err
...
python scripts/evaluate.py \
    ...
    --limit $LIMIT \
    --offset $OFFSET \
    --output-dir evaluation/results/eval_limo/deeptheorem \
    --verbose
