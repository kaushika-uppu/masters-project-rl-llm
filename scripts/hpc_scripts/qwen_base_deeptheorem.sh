#!/bin/bash
#SBATCH --job-name=eval_base_dt
#SBATCH --output=logs/eval_base_dt/eval_base_%A_%a.out
#SBATCH --error=logs/eval_base_dt/eval_base_%A_%a.err
...
python scripts/evaluate.py \
    ...
    --limit $LIMIT \
    --offset $OFFSET \
    --output-dir evaluation/results/eval_base/deeptheorem \
    --verbose
