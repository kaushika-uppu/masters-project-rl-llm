#!/bin/bash
#SBATCH --job-name=eval_sft_rb
#SBATCH --output=logs/eval_sft_rb/eval_sft_%A_%a.out
#SBATCH --error=logs/eval_sft_rb/eval_sft_%A_%a.err
...
python scripts/evaluate.py \
    ...
    --inference-fn sft_merged \
    --limit $LIMIT \
    --offset $OFFSET \
    --output-dir evaluation/results/eval_sft/riddlebench \
    --verbose
